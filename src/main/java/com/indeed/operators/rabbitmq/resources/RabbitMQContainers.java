...
public class RabbitMQContainers {
    public Container buildContainer(
        ...
        return new ContainerBuilder()
                ...
                .addNewEnv().withName("RABBITMQ_DEFAULT_USER").withNewValueFrom().withNewSecretKeyRef("default-username", secretName, false).endValueFrom().endEnv()
                .addNewEnv().withName("RABBITMQ_DEFAULT_PASS").withNewValueFrom().withNewSecretKeyRef("default-password", secretName, false).endValueFrom().endEnv()
